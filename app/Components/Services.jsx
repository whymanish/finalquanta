...
const Services = () => {
  return (
    ...
    <section class=" relative overflow-hidden">
      ...
      <svg class="absolute opacity-30" viewBox="0 0 960 637" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="relative flex flex-col items-center justify-center max-w-6xl px-8  mx-auto ">
        <div>
          <p class="mt-8 text-4xl text-center font-semibold tracking-tight text-white lg:text-5xl">
           WebApps Development
            <span class="md:block"></span>
          </p>
          <p class="max-w-xl mt-4 text-center text-lg text-gray-400">
        ...
        <div class="grid grid-cols-1 gap-8 mt-12 lg:ap-2 lg:grid-cols-3">
          <div class="lg:order-last">
            <div class="flex flex-col">
              <div class="p-8 shadow-2xl rounded-3xl bg-[#1c1f29] ring-1 ring-white/10">
                ...
                <div class="flex mt-6">
                  <a class="items-center justify-between inline-flex w-full font-medium px-6 py-2.5 text-center text-black duration-200 bg-white rounded-xl h-14 hover:bg-white/20 hover:border-white hover:text-white focus:outline-none focus-visible:outline-black text-base focus-visible:ring-black" href="#">
              ...
              <div class="px-8">
                <div>
                  ...
                  <ul class="order-last gap-4 mt-4 space-y-3 text-gray-300 list-none" role="list">
                    <li class="flex items-center gap-2">
                      <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-300 icon icon-tabler icon-tabler-circle-check" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div>
            <div class="flex flex-col">
              <div class="p-8 rounded-3xl bg-[#1c1f29] ring-1 ring-white/10 shadow-2xl">
                ...
                <div class="flex mt-6">
                  <a class="items-center justify-between inline-flex w-full font-medium px-6 py-2.5 text-center text-white duration-200 bg-white/5 border border-white/5 rounded-xl h-14 hover:bg-white/10 hover:border-white/10 focus:outline-none focus-visible:outline-black text-base focus-visible:ring-black" href="#">
                    Get starter <span>→</span>
                  </a>
                </div>
              </div>
