    ...
    <div>
      ...
      <header>
        <div class="px-5 md:px-10 mb-28">
          ...
          <div class="mx-auto w-full max-w-7xl rounded-[48px] bg-cover bg-center bg-no-repeat py-20 text-white [box-shadow:rgb(106,_218,_255)_9px_9px]" style={{ backgroundImage: "url('https://assets.website-files.com/63904f663019b0d8edf8d57c/6391a6daa19785eb51dd3666_CTA%20(2).svg')" }}>
            <div class="mx-auto max-w-3xl text-center">
              ...
              <a href="#" class="inline-block rounded-xl bg-black px-8 py-4 font-semibold text-white [box-shadow:rgb(255,_255,_255)_6px_6px]">Get Started</a>
            </div>
          </div>
        </div>
      </header>
