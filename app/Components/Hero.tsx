...
const Hero = () => {
    ...
    <section className="py-20">
        <div className="relative  items-center w-full px-5  mx-auto max-w-7xl lg:px-16 md:px-12">
            <div>
                <div className="text-center max-w-4xl mx-auto mt-10 lg:mt-0 ">
                    <span className="bg-[#f2f4f6] px-4 py-2 rounded-full w-auto"><span className="text-sm text-gray-800">Quantafile offers</span></span>
                    <p className="mt-8 text-3xl font-extrabold tracking-tight text-gray-100 lg:text-6xl">
                    The website you want without the Dev time
                    </p>
                    <p className="max-w-xl mx-auto mt-4 text-base lg:text-xl text-slate-200">
                        We help sales teams increase their outbound with scalable and high
                        quality customized emails for every prospect.
                    </p>
                </div>
            </div>
            <div className="relative items-center w-full pt-12 pb-12 mx-auto mt-12 max-w-7xl">
